      ...
      <Media>
        ...
        <Media.Body>
          ...
          >
            ...
            object-oriented programming, MySQL, NodeJS, and Bootstrap. I was
            able to excel in the fast paced environment due to my prior work
            experience, collaborating with dynamic teams and helping motivate
            ...
            problematic external API calls. In my second month, I was
            responsible for creating the Handlebars Layout for another project
            as well as debugging and acting as the team’s Scrum-Master.
            <br></br>
            <br></br>
            Using what I already know about creative problem solving, forward
            thinking, and cross-functional collaboration will allow me to
            develop applications that fulfill client needs. I am excited to use
            my newly gained and existing skills as a Software Engineer!
          </p>
        </Media.Body>
      </Media>
    </div>
